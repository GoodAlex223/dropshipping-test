...
- **Active tasks**: TASK-033 post-freeze resumption validation (PR #16, in review); v1.3 "Mirox Rebrand Demo" tasks TASK-034..040 planned in TODO.md — see docs/superpowers/specs/2026-07-14-mirox-shop-program-design.md for the Mirox Shop program (rebrand + Ukraine launch, milestones v1.3/v1.4/v2.0)
