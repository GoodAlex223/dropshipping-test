...
| [superpowers/specs/2026-09-10-g19-launch-runbook-deploy-verification-design.md](superpowers/specs/2026-09-10-g19-launch-runbook-deploy-verification-design.md) | **G19 design**: launch runbook + deploy verification — one-time real-domain cutover checklist (⛔ TASK-056-gated steps) + every-deploy checks, `scripts/smoke.ts` 13-row probe set with origin-keyed CSS-hash baseline and three-state staleness, SSRF accept/reject probe pairing                                            | 2026-09-10   |
