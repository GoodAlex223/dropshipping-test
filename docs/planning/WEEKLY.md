...
- [x] 🏆 **[G12](#g12-categories-to-catalog-redesign-batch-)** 🔵 — stretch, behind everything above. **Shipped Tue 2026-08-18** (+4 days past the Friday, weekend/Monday spill) — `feat/g12-categories-to-catalog` tip `f94c03a`, user-approved at the browser gate. No PR and **not merged to main** by user instruction; the SHA is the resolvable pointer.
...
| G12 | Categories-to-Catalog Redesign `[batch]` 🏆         | storefront/catalog | 🔵 User     | 3      | 5        | Fri (stretch) | ✅ `f94c03a` (branch, unmerged)                                       |
